package com.omarahmed42.physics2d;
...
public class Physics2D {
    ...
    public void add(GameObject go) {
        ...
        if (rb != null && rb.getRawBody() == null) {
            ...
            // Currently supporting boxes and circles
    ...
    public RaycastInfo raycast(GameObject requestingObject, Vector2f point1, Vector2f point2) {
        ...
        world.raycast(callback,
                new Vec2(point1.x, point1.y), new Vec2(point2.x, point2.y));
        return callback;
    }
    ...
    public static boolean checkOnGround(GameObject gameObject,
            float innerPlayerWidth, float height) {
